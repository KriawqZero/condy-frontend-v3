...
export async function createImovelAction(formData: FormData): Promise<ResponsePayload<Imovel>> {
  try {
    const rawData = {
      ...
      quantidade_moradias: parseInt(formData.get('quantidade_moradias') as string, 10),
