    ...
    <div className='flex bg-white flex-col min-h-screen'>
      ...
      <div className='flex flex-grow w-full overflow-auto'>
        <div className='w-full lg:w-1/2 bg-white flex flex-col px-4 py-8 sm:px-10 lg:px-20'>
          <header className='flex justify-center mb-6 md:justify-start md:mb-0 md:pt-8'>
            <img src='/horizontal_logo.svg' alt='Condy' className='h-8 md:h-10' />
          </header>
              ...
              <div className='mt-6 md:mt-8 p-4 bg-[#F5F7FF] rounded-xl'>
                <div className='flex items-center'>
                  ...
                  <div className='ml-3 md:ml-4 flex-1'>
                    ...
                    <p className='text-xs md:text-sm text-gray-600'>Fale com a gente pelo WhatsApp</p>
                  </div>
                  <div className='flex-shrink-0'>
                    ...
                    >
                      <img src='/svg/arrow_right.svg' alt='Seta para direita' className='w-6 h-6 md:w-7 md:h-7' />
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className='hidden lg:flex lg:w-1/2 relative'>
          <img src='/imagem_fundo.png' alt='Ambiente moderno de condomínio' className='w-full h-full object-cover' />
        </div>
      </div>
      ...
      <footer className='bg-blue-600 py-4 md:py-6 text-white text-center'>
        <div className='flex flex-col md:flex-row md:justify-center md:items-center md:space-x-8 items-center space-y-3 md:space-y-0'>
          <img src='/horizontal_logo_white.svg' alt='Condy' className='h-6' />

          <div className='flex items-center justify-center text-xs'>
            <img src='/svg/incubadora_logo.svg' alt='Incubadora' className='h-5 mx-2' />
          </div>

          <div className='flex items-center justify-center text-xs'>
            <img src='/logo_aceleradora.png' alt='Aceleradora' className='h-5 mx-2' />
          </div>
        </div>

        <div className='text-xs text-white/80 mt-3 md:mt-4'>
          Condy Tecnologia LTDA © 2025 <br />
          Todos os direitos reservados <br />
          CNPJ 60.185.344/0001-44
        </div>
      </footer>
    </div>
  );
