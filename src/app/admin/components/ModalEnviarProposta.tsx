...
export function ModalEnviarProposta({ chamado, onClose, onSuccess }: ModalEnviarPropostaProps) {
  ...
  const handleDecisaoContraproposta = async (
    propostaId: number,
      ...
      >
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6">
              ...
              <div>
                ...
                />
                {isFaixaInvalida && (
                  <div className="text-xs text-red-500 mt-1 font-afacad">
        ...
        {propostasChamado.length > 0 && (
          <div className="border-t border-gray-100 bg-gray-50">
            <div className="p-4 sm:p-6">
              <h3 className="font-afacad text-lg font-bold text-black mb-4">
                Propostas deste chamado
              </h3>
                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      <div className="space-y-1">
                        ...
                        <div className="font-afacad text-sm text-gray-600">
                          <span className="font-bold text-black">Sugestão:</span>{" "}
                        ...
                        {(proposta.contrapropostaPrecoMin || proposta.contrapropostaPrecoMax) && (
                          <div className="font-afacad text-sm text-gray-600">
                            ...
                            {proposta.contrapropostaPrecoMin || "-"} ~{" "}
                            {proposta.contrapropostaPrecoMax || "-"} | Prazo:{" "}
