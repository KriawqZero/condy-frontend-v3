    ...
    <footer className='bg-blue-600 py-8 text-white'>
      <div className='container mx-auto px-4'>
        <div className='flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0'>
          <img src='/horizontal_logo_white.svg' alt='Condy' className='h-8 md:h-10 text-white' />

          <div className='flex items-center space-x-4'>
            <img src='/svg/incubadora_logo.svg' alt='Incubadora' className='h-8' />

            <img src='/logo_aceleradora.png' alt='Aceleradora' className='h-8' />
          </div>
        </div>
