      ...
      <div className='bg-white w-full max-w-lg rounded-2xl p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto'>
        ...
        <div className='flex items-center justify-between mb-6'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h3 className='text-lg font-bold font-afacad text-black'>Cadastrar Novo Imóvel</h3>
              <p className='text-sm text-gray-600'>Informe o endereço e dados do imóvel</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div className='grid grid-cols-1 gap-4'>
            {/* Nome do Imóvel */}
            <div>
              <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Nome do Imóvel *</label>
              <input
                type='text'
                name='nome'
                required
            ...
            <div className='grid grid-cols-2 gap-3'>
              <div>
                <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>CEP *</label>
                <input
                  type='text'
                  name='cep'
                  required
              ...
              <div>
                <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Número *</label>
                <input
                  type='text'
                  name='numero'
                  required
            ...
            {/* Endereço */}
            <div>
              <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Endereço *</label>
              <input
                type='text'
                name='endereco'
                required
            ...
            <div className='grid grid-cols-3 gap-3'>
              <div>
                <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Bairro *</label>
                <input
                  type='text'
                  name='bairro'
                  required
              ...
              <div>
                <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Cidade *</label>
                <input
                  type='text'
                  name='cidade'
                  required
              ...
              <div>
                <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>UF *</label>
                <input
                  type='text'
                  name='uf'
                  required
            ...
            {/* Complemento */}
            <div>
              <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Complemento</label>
              <input
                type='text'
                name='complemento'
                className='w-full border-2 border-[#1F45FF] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-100'
            ...
            <div>
              <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>Quantidade de Moradias *</label>
              <input
                type='number'
