...
export function CondySelect({
  ...
  return (
    <div className='relative'>
      <label className='block text-sm font-afacad text-[#1F45FF] mb-1'>{label}</label>
      ...
      <div className='relative'>
        <button
          ...
          className={`w-full border-2 rounded-xl px-4 py-3 text-left flex items-center justify-between transition-all ${
            error ? 'border-red-500' : isOpen ? 'border-[#1F45FF] ring-2 ring-blue-100' : 'border-[#1F45FF]'
          ...
          <div className='flex items-center gap-2'>
            {customIcon || (
              <svg width='24' height='26' viewBox='0 0 24 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                />
                <path
                  d='M6.37988 9.53234L7.12988 10.2823L9.37988 8.03234'
                  stroke='black'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                ...
                />
                <path
                  d='M6.37988 16.5323L7.12988 17.2823L9.37988 15.0323'
                  stroke='black'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                />
                <path
                  d='M9 22.6523H15C20 22.6523 22 20.6523 22 15.6523V9.65234C22 4.65234 20 2.65234 15 2.65234H9C4 2.65234 2 4.65234 2 9.65234V15.6523C2 20.6523 4 22.6523 9 22.6523Z'
                  stroke='black'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
