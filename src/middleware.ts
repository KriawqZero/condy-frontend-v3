...
const protectedRoutes = ['/sindico', '/admin', '/admin-imoveis', '/prestador', '/dashboard'];
...
const routesByUserType = {
  ...
  ADMIN_IMOVEIS: ['/admin-imoveis'],
  PRESTADOR: ['/prestador'],
  ADMIN_PLATAFORMA: ['/admin', '/sindico', '/admin-imoveis', '/prestador'],
};
